...
from mini_rainbowdqn import MiniRainbowDQNAgent, deque, np, torch
...
# plot the mini_rainbow_dqn_scores
fig = plt.figure()
ax = fig.add_subplot(111)
plt.plot(np.arange(len(mini_rainbow_dqn_scores)), mini_rainbow_dqn_scores)
plt.ylabel('Score')
plt.xlabel('Episodes')
plt.show()
